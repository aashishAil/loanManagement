...
var (
	...
	InvalidPaymentAmountError                  = errors.New("payment amount should not be greater than loan amount")
	NoScheduledRepaymentFoundError             = errors.New("no scheduled repayments found")
	PaymentAmountScheduledPaymentMismatchError = errors.New("payment amount cannot be lower than scheduled repayment amount")
)
